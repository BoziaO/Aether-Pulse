...
export const getListMessagesQueryOptions = <TData = Awaited<ReturnType<typeof listMessages>>, TError = ErrorType<unknown>>(roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMessages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useListMessages<TData = Awaited<ReturnType<typeof listMessages>>, TError = ErrorType<unknown>>(
 roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listMessages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const getRoomActivity = async (roomId: string, options?: RequestInit): Promise<RoomActivity> => {
...
export const getGetRoomActivityQueryOptions = <TData = Awaited<ReturnType<typeof getRoomActivity>>, TError = ErrorType<unknown>>(roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getRoomActivity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetRoomActivityQueryKey(roomId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getRoomActivity>>> = ({ signal }) => getRoomActivity(roomId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(roomId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRoomActivity>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetRoomActivity<TData = Awaited<ReturnType<typeof getRoomActivity>>, TError = ErrorType<unknown>>(
 roomId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getRoomActivity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
