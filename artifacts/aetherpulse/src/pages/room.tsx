...
import { Camera, Mic, MonitorUp, PhoneOff, Settings2, Video, Send, User, Users, ShieldAlert, MessageSquare, ChevronDown, Check } from "lucide-react";
          ...
          <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-20">
            <GlassCard className="px-4 md:px-6 py-3 md:py-4 rounded-full md:rounded-3xl flex items-center gap-3 md:gap-4 bg-background/80 backdrop-blur-xl border-white/10 shadow-2xl">
              ...
              <GlassButton 
                ...
                className={`w-12 h-12 md:w-14 md:h-14 rounded-full md:rounded-2xl ${isScreenSharing ? 'bg-primary/50 border-primary shadow-[0_0_15px_rgba(124,58,237,0.5)]' : 'bg-white/5 hover:bg-white/10'}`}
