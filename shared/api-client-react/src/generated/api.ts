...
export const getRefreshMutationOptions = <TError = ErrorType<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export type RefreshMutationBody = BodyType<RefreshTokenBody>
export type RefreshMutationError = ErrorType<void>

/**
 * @summary Refresh JWT token
 */
export const useRefresh = <TError = ErrorType<void>, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof refresh>>,
    TError,
    { data: BodyType<RefreshTokenBody> },
...
>(
  ...
  return {
    ...
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getRoom>>, TError, TData> & { queryKey: QueryKey }
}
...
>(
  ...
  return {
    ...
    enabled: roomId !== null && roomId !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getRoomActivity>>, TError, TData> & {
    queryKey: QueryKey
  }
}
