...
export const UpdateUserBody = zod.object({
  ...
  bio: zod.string().max(190).nullish(),
  pronouns: zod.string().max(40).nullish(),
  website: zod.string().max(120).nullish(),
  location: zod.string().max(40).nullish(),
  customStatus: zod.string().max(128).nullish(),
  accentColor: zod
    .string()
    .regex(/^#[0-9A-Fa-f]{6}$/)
    .optional(),
